...
import com.greenLogBackend.greenLogSolution.service.ConsultaAvancadaService;
...
public class PontoColetaController {
    ...
    public PontoColetaController(PontoColetaService pontoColetaService, ConsultaAvancadaService consultaAvancadaService) {
    ...
    @GetMapping("/avancada")
    public ResponseEntity<List<PontoColeta>> consultaAvancada(@RequestParam String query) {
        return ResponseEntity.ok(consultaAvancadaService.executarConsulta(query));
    }

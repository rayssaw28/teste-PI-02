...
public class Usuario implements UserDetails {
    ...
    // Enum simples: ADMIN ou USER (você precisará criar esse Enum)
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        // Assume que PerfilUsuario tem o nome da role (ex: ROLE_ADMIN)
    ...
    // Getters e Setters normais omitidos para brevidade...

...
public class ItinerarioService {
    ...
    public Itinerario agendar(Long rotaId, LocalDate data) {
        ...
        // Regra de Negócio: Verificar conflito de agenda
        boolean existeConflito = itinerarioRepository.existsByCaminhaoAndData(rota.getCaminhao().getId(), data);
        ...
        itinerario.setCaminhao(rota.getCaminhao()); // Redundante mas útil para consultas rápidas
